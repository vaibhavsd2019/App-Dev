	...
	private static String executeFSM(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if (currentChar == '2' || currentChar == '4' ||currentChar == '6' || currentChar == '8') {
					state = 1;
					break;
				}
			...
			case 2: 
				...
				// If the current character is in the set {0, 2, 4, 6, 8}, is transitions to state 1
				else if (currentChar == '2' || currentChar == '4' || currentChar == '6' || currentChar == '8') {
					state = 1;
					break;
				}
