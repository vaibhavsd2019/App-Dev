 ...
 * 
 * @version 4.3	2018-02-25	Part 3 The mainline of a JavaFX-based GUI implementation of a double integer calculator
 * 
 */
...
public class Calculator extends Application {
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Vaibhav Mehandiratta's FSM Calculator");				// Label the stage (a window)
